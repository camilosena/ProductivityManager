DROP DATABASE IF EXISTS productivitymanager;CREATE DATABASE IF NOT EXISTS productivitymanager;USE productivitymanager;<br>DROP TABLE IF EXISTS roles;\n\n>CREATE TABLE `roles` (
  `idRoles` int(11) NOT NULL,
  `rol` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idRoles`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8\n\nINSERT INTO roles VALUES ("0","default");\n\nINSERT INTO roles VALUES ("1","Administrador");\n\nINSERT INTO roles VALUES ("2","Gerente");\n\nINSERT INTO roles VALUES ("3","Empleado");\n\nINSERT INTO roles VALUES ("4","Clientes");\n\n<br>DROP TABLE IF EXISTS areas;\n\n>CREATE TABLE `areas` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8\n\n<br>DROP TABLE IF EXISTS productos;\n\n>CREATE TABLE `productos` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8\n\n<br>DROP TABLE IF EXISTS materiaprima;\n\n>CREATE TABLE `materiaprima` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8\n\n<br>DROP TABLE IF EXISTS materiaprimaporproducto;\n\n>CREATE TABLE `materiaprimaporproducto` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8\n\n<br>DROP TABLE IF EXISTS materiaprimaporproyecto;\n\n>CREATE TABLE `materiaprimaporproyecto` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8\n\n<br>DROP TABLE IF EXISTS novedades;\n\n>CREATE TABLE `novedades` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8\n\n<br>DROP TABLE IF EXISTS procesosporproyecto;\n\n>CREATE TABLE `procesosporproyecto` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8\n\n<br>DROP TABLE IF EXISTS productoporproyecto;\n\n>CREATE TABLE `productoporproyecto` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8\n\n<br>DROP TABLE IF EXISTS usuarioporproyecto;\n\n>CREATE TABLE `usuarioporproyecto` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8\n\n<br>DROP TABLE IF EXISTS usuarios;\n\n>CREATE TABLE `usuarios` (
